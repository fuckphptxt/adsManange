import{i as o}from"./mock-api-DZzX7MMP.js";import{P as h}from"./index-nsw1gsVQ.js";import{b9 as e,V as D,Q as p,B as f}from"./antd-DeDWztM9.js";import{d as r,k as u,G as t,f as m,u as d,c as g,r as F}from"./vue-BsEqlI2B.js";import{u as i}from"./index-DsC7X2Jz.js";import"./entry/index-DeA-E56H-1712476170604.js";import"./useContentViewHeight-CYeOqeUw.js";import"./useWindowSizeFn-dzDjg1EY.js";import"./onMountedOrActivated-DNS7E5S8.js";const C=[{label:"Jack",value:"Jack"},{label:"Lucy",value:"Lucy"},{label:"Lutz",value:"Lutz"}],v=r({setup(){const a=m("Lutz"),{data:n,loading:l}=i(()=>o(a.value),{refreshDeps:[a]});return()=>u(p,{title:"Ref 依赖刷新"},{default:()=>[u(e,null,{default:()=>[u(e.Paragraph,null,{default:()=>[t("useRequest 提供了一个"),u(e.Text,{type:"danger"},{default:()=>[t(" options.refreshDeps ")]}),t("参数，当它的值变化后，会重新触发请求。")]}),u(e.Paragraph,null,{default:()=>[u(e.Text,null,{default:()=>[u("pre",null,[`const select = ref('Lutz');
